...
namespace epsi.Areas.Admin.Controllers
{
    ...
    public class MenuController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Create([DataSourceRequest] DataSourceRequest request, [Bind(Prefix = "models")]IEnumerable<epsi.Models.Menu> Menus)
        {
            var results = new List<epsi.Models.Menu>();
        ...
        [HttpPost]
        public ActionResult Edit([DataSourceRequest] DataSourceRequest request, [Bind(Prefix = "models")]IEnumerable<epsi.Models.Menu> Menus)
        {
            if (Menus != null && ModelState.IsValid)
            {
                foreach (var Menu in Menus)
        ...
        [HttpPost]
        public ActionResult Delete([DataSourceRequest] DataSourceRequest request, [Bind(Prefix = "models")]IEnumerable<epsi.Models.Menu> Menus)
        {
            if (Menus.Any())
            {
                foreach (var menu in Menus)
