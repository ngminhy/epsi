...
namespace epsi.Areas.Admin.Controllers
{
    ...
    public class CommentController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Create([DataSourceRequest] DataSourceRequest request, [Bind(Prefix = "models")]IEnumerable<epsi.Models.Comment> Comments)
        {
            var results = new List<epsi.Models.Comment>();
        ...
        [HttpPost]
        public ActionResult Edit([DataSourceRequest] DataSourceRequest request, [Bind(Prefix = "models")]IEnumerable<epsi.Models.Comment> Comments)
        {
            if (Comments != null && ModelState.IsValid)
            {
                foreach (var Comment in Comments)
        ...
        [HttpPost]
        public ActionResult Delete([DataSourceRequest] DataSourceRequest request, [Bind(Prefix = "models")]IEnumerable<epsi.Models.Comment> Comments)
        {
            if (Comments.Any())
            {
                foreach (var Comment in Comments)
