...
namespace epsi.Areas.Admin.Controllers
{
    public class LocationController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Create([DataSourceRequest] DataSourceRequest request, [Bind(Prefix = "models")]IEnumerable<epsi.Models.Location> Locations)
        {
            var results = new List<epsi.Models.Location>();
        ...
        [HttpPost]
        public ActionResult Edit([DataSourceRequest] DataSourceRequest request, [Bind(Prefix = "models")]IEnumerable<epsi.Models.Location> Locations)
        {
            if (Locations != null && ModelState.IsValid)
            {
                foreach (var Location in Locations)
        ...
        [HttpPost]
        public ActionResult Delete([DataSourceRequest] DataSourceRequest request, [Bind(Prefix = "models")]IEnumerable<epsi.Models.Location> Locations)
        {
            if (Locations.Any())
            {
                foreach (var Location in Locations)
